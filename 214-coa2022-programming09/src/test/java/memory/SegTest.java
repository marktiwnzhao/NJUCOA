...
public class SegTest {
    ...
    public void test2() {
        int len = 128;
        byte[] expect = helper.fillData('0', len);
        byte[] actual = mmu.read("000000000000100000000000000000000000000000000000", len);
        assertArrayEquals(expect, actual);
    ...
    public void test3() {
        ...
        byte[] expect = helper.fillData('4', len);
        byte[] actual = mmu.read("000000000001000000000000000000000000000000000000", len);
        assertArrayEquals(expect, actual);
