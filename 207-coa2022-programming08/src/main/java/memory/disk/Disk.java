...
public class Disk {
    ...
    private static class DiskHead {
        ...
        public void seek(int start) {
            // TODO
            start %= (TRACK_NUM*SECTOR_PER_TRACK*BYTE_PER_SECTOR);
            track = start / (SECTOR_PER_TRACK*BYTE_PER_SECTOR);
            start -= track * (SECTOR_PER_TRACK*BYTE_PER_SECTOR);
            sector = start / BYTE_PER_SECTOR;
